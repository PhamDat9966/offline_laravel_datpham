            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{!!asset('news/images/article/e7YyFZJCc8.jpeg')!!}"
                                                 alt="{!!asset('news/images/article/e7YyFZJCc8.jpeg')!!}"
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{!!asset('news/images/article/exzJEG4WDU.jpeg')!!}"
                                                 alt="{!!asset('news/images/article/exzJEG4WDU.jpeg')!!}"
                                                 class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{!!asset('news/images/article/TpcocqUjob.png')!!}"
                                                 alt="{!!asset('news/images/article/TpcocqUjob.png')!!}"
                                                 class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{!!asset('news/images/article/gCPGos7mhY.png')!!}"
                                                     alt="{!!asset('news/images/article/gCPGos7mhY.png')!!}"
                                                     class="img-fluid w-100"></div>
                        <div class="post_content">
                            <div class="post_category cat_technology ">
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{!!asset('news/images/article/nt1QxhKUXM.jpeg')!!}"
                                                     alt="{!!asset('news/images/article/nt1QxhKUXM.jpeg')!!}"
                                                     class="img-fluid w-100"></div>
                        <div class="post_content">
                            <div class="post_category cat_technology ">
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{!!asset('news/images/article/aiC6j6fWZY.png')!!}"
                                                     alt="{!!asset('news/images/article/aiC6j6fWZY.png')!!}"
                                                     class="img-fluid w-100"></div>
                        <div class="post_content">
                            <div class="post_category cat_technology ">
                                <a href="the-loai/so-hoa-6.html">Số hóa</a>
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{!!asset('news/images/article/9jOZGc7BJK.png')!!}"
                                                     alt="{!!asset('news/images/article/9jOZGc7BJK.png')!!}"
                                                     class="img-fluid w-100"></div>
                        <div class="post_content">
                            <div class="post_category cat_technology ">
                                <a href="the-loai/so-hoa-6.html">Số hóa</a>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{!!asset('news/images/article/g2c7mYXBPW.png')!!}"
                                                 alt="{!!asset('news/images/article/g2c7mYXBPW.png')!!}"
                                                 class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{!!asset('news/images/article/9fbeUKTBpU.png')!!}"
                                                 alt="{!!asset('news/images/article/9fbeUKTBpU.png')!!}"
                                                 class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
