        ...
        <div class="content_container container_category">
           <div class="featured_title">
              <div class="container">
                 <div class="row">
                    <div class="col-lg-8">
                        @include('news.en.pages.rss.child-index.list',['items'=>$items])
                    </div>
                    <div class="col-lg-4">
                        <h3>Giá Vàng</h3>
                        ...
                        {{-- @include('news.en.pages.rss.child-index.box-gold',['itemsGold'=>$itemsGold]) --}}
                        <h3>Giá Coin</h3>
                        <div id="box-coin" class="d-flex align-items-center justify-content-center" data-url="{{route('rss/get-coin')}}">
                            <img src="{{ asset('images/loading.gif') }}" alt="">
                        </div>
                        {{-- @include('news.en.pages.rss.child-index.box-coin',['itemsCoin'=>$itemsCoin]) --}}
                    </div>
                 </div>
              </div>
           </div>
