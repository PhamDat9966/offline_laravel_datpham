    ...
    <div class="col-lg-12">
        <div class="row">
            @foreach ($item->article_child as $article_child)
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        @include('news.vi.partials.article.image',['item'=>$article_child])
                        @include('news.vi.partials.article.content',['item'=>$article_child,'lenghtContent'=> 200,'showCategory'=>false])
                    </div>
                </div>
